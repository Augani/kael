...
### 3a. Production-framework bar (native desktop capability bar, "handle any load")
...
| **Perf budgets** | Steady 60/120fps, input-to-photon < 2 frames; bounded memory over an 8-hour session (no leaks); cold start beats the baseline; 100k-row virtualized list at 60fps |
