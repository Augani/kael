...
switch ($Mode) {
    "default" {
        ...
        Invoke-Step cargo check --package kael --lib --features 'audio'
        ...
        Invoke-Step cargo check --package kael --lib --features 'platform-foundation document audio pdf notifications-full share'
