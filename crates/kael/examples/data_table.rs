...
impl Quote {
    ...
    fn change_color(&self) -> kael::Hsla {
        if self.change() > 0.0 {
            kael::green()
        } else {
            kael::red()
...
impl TableRow {
    ...
    fn render_cell(&self, key: &str, width: Pixels, color: kael::Hsla) -> impl IntoElement {
        div()
            .whitespace_nowrap()
            .truncate()
            .w(width)
...
impl DataTable {
    ...
    fn render_scrollbar(&mut self, _: &mut Window, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        div()
            ...
            .child(
                canvas(
                    |_: kael::Bounds<kael::Pixels>, _: &mut kael::Window, _: &mut kael::App| (),
                    move |thumb_bounds: kael::Bounds<kael::Pixels>,
                          _,
