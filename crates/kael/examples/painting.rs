...
impl PaintingViewer {
    fn new(_window: &mut Window, _cx: &mut Context<Self>) -> Self {
        ...
        builder.scale(0.9);
        let path = builder.build().unwrap();
        lines.push((path, kael::black().into()));
        ...
        lines.push((
            ...
            linear_gradient(
                180.,
                linear_color_stop(kael::blue(), 0.4),
                linear_color_stop(kael::red(), 1.),
            ),
        ));
        ...
        let path = builder.build().unwrap();
        lines.push((path, kael::green().into()));
        ...
        div()
            ...
            .child(
                div()
                            ...
                            | {
                                ...
                                for points in lines {
                                    ...
                                    if let Ok(path) = builder.build() {
                                        window.paint_path(path, kael::black());
                                    }
                                }
                            },
                        )
                    ...
                    .on_mouse_move(cx.listener(|this, ev: &kael::MouseMoveEvent, _, cx| {
                        if !this._painting {
                            return;
                        }
