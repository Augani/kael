...
// 3. We need to implement the techniques in here in Kael
        ...
        div()
            ...
            .map(|div| match decorations {
                ...
                Decorations::Client { tiling, .. } => div
                    ...
                    .child(
                        canvas(
                            |_bounds: Bounds<Pixels>, window: &mut Window, _cx: &mut App| {
