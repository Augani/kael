...
use crate::{
    ...
    ClipboardItem, CommandRegistry, CrashReport, CursorStyle, DialogOptions, DispatchPhase,
    DisplayId, EventEmitter, FileWatcher, FocusHandle, FocusMap, FocusedWindowInfo,
    ForegroundExecutor, Global, KeyBinding, KeyContext, Keymap, Keystroke, LayoutId, MediaKeyEvent,
    Menu, MenuItem, NetworkStatus, NotificationAction, OsInfo, OwnedMenu, PathPromptOptions,
    PathScope, PermissionBroker, PermissionResult, PermissionStatus, Pixels, Platform,
    PlatformDisplay, PlatformKeyboardLayout, PlatformKeyboardMapper, Point, PowerMode,
    PowerSaveBlockerKind, ProcessClass, ProcessId, PromptBuilder, PromptButton, PromptHandle,
    PromptLevel, Redo, Render, RenderImage, RenderablePromptHandle, Reservation,
    ScreenCaptureSource, SharedString, Size, SubscriberSet, Subscription, SvgRenderer,
...
mod test {
    ...
    use crate::{AppContext, DeepLinkHandler, TestAppContext};
    ...
    fn test_open_url_dispatch_multiplexes_observers_and_deep_links() {
        ...
        cx.simulate_open_urls(&["myapp://settings", "other://ignored"]);
