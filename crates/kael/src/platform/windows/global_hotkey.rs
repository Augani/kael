...
/// Returns the virtual key code for the given keystroke's key string.
pub(crate) fn virtual_key_for_keystroke(keystroke: &Keystroke) -> Result<VIRTUAL_KEY> {
    map_key_to_vk(&keystroke.key)
}
