    ...
    fn prepaint(
        ...
        self.interactivity.prepaint(
            ...
            |style, mut scroll_offset, hitbox, window, cx| {
                ...
                let original_scroll_offset = *shared_scroll_offset.borrow();
                ...
                if self.item_count > 0 && has_usable_item_height(item_height) {
                    ...
                    if is_scrolled_vertically
                        && logical_scroll_offset.y < min_vertical_scroll_offset
                    {
                    ...
                    if let Some(deferred_scroll) = shared_scroll_to_item {
                        ...
                        *updated_scroll_offset = logical_scroll_offset;
                    ...
                    scroll_offset = if logical_scroll_offset == original_scroll_offset {
                        logical_scroll_offset + elastic_offset
                    } else {
                        logical_scroll_offset
                    };
