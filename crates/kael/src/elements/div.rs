...
fn rubber_band_scroll_enabled(event: &ScrollWheelEvent) -> bool {
...
fn pixels_have_same_sign(left: Pixels, right: Pixels) -> bool {
    (left > Pixels::ZERO && right > Pixels::ZERO) || (left < Pixels::ZERO && right < Pixels::ZERO)
}

fn consume_scroll_elasticity(overscroll: &mut Pixels, delta: Pixels) -> Pixels {
...
fn add_scroll_elasticity(overscroll: Pixels, delta: Pixels) -> Pixels {
...
fn advance_scroll_elasticity(overscroll: &mut Pixels) -> bool {
...
mod test {
    use super::{
        ImplicitStyleAnimationState, ImplicitVisualStyle, TOOLTIP_SHOW_DELAY,
