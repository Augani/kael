...
pub fn visibility_style_methods(input: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        #visibility fn visible(mut self) -> Self {
            self.style().visibility = Some(kael::Visibility::Visible);
            self
        }
        ...
        #visibility fn invisible(mut self) -> Self {
            self.style().visibility = Some(kael::Visibility::Hidden);
            self
        }
    };
...
pub fn position_style_methods(input: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        #visibility fn relative(mut self) -> Self {
            self.style().position = Some(kael::Position::Relative);
            self
        }
        ...
        #visibility fn absolute(mut self) -> Self {
            self.style().position = Some(kael::Position::Absolute);
            self
        }
...
pub fn overflow_style_methods(input: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        #visibility fn overflow_hidden(mut self) -> Self {
            self.style().overflow.x = Some(kael::Overflow::Hidden);
            self.style().overflow.y = Some(kael::Overflow::Hidden);
            self
        }
...
pub fn cursor_style_methods(input: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        #visibility fn cursor_default(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::Arrow);
            self
        }
        ...
        #visibility fn cursor_pointer(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::PointingHand);
            self
        }
        ...
        #visibility fn cursor_text(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::IBeam);
            self
        }
        ...
        #visibility fn cursor_move(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::ClosedHand);
            self
        }
        ...
        #visibility fn cursor_not_allowed(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::OperationNotAllowed);
            self
        }
        ...
        #visibility fn cursor_context_menu(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::ContextualMenu);
            self
        }
        ...
        #visibility fn cursor_crosshair(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::Crosshair);
            self
        }
        ...
        #visibility fn cursor_vertical_text(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::IBeamCursorForVerticalLayout);
            self
        }
        ...
        #visibility fn cursor_alias(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::DragLink);
            self
        }
        ...
        #visibility fn cursor_copy(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::DragCopy);
            self
        }
        ...
        #visibility fn cursor_grab(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::OpenHand);
            self
        }
        ...
        #visibility fn cursor_ew_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::ResizeLeftRight);
            self
        }
        ...
        #visibility fn cursor_ns_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::ResizeUpDown);
            self
        }
        ...
        #visibility fn cursor_nesw_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::ResizeUpRightDownLeft);
            self
        }
        ...
        #visibility fn cursor_nwse_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::ResizeUpLeftDownRight);
            self
        }
        ...
        #visibility fn cursor_col_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::ResizeColumn);
            self
        }
        ...
        #visibility fn cursor_row_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::ResizeRow);
            self
        }
        ...
        #visibility fn cursor_n_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::ResizeUp);
            self
        }
        ...
        #visibility fn cursor_e_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::ResizeRight);
            self
        }
        ...
        #visibility fn cursor_s_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::ResizeDown);
            self
        }
        ...
        #visibility fn cursor_w_resize(mut self) -> Self {
            self.style().mouse_cursor = Some(kael::CursorStyle::ResizeLeft);
            self
        }
...
pub fn box_shadow_style_methods(input: TokenStream) -> TokenStream {
    ...
    let output = quote! {
        ...
        #visibility fn shadow(
            mut self,
            shadows: impl Into<smallvec::SmallVec<[kael::BoxShadow; 1]>>,
        ) -> Self {
        ...
        #visibility fn shadow_2xs(mut self) -> Self {
            use kael::{BoxShadow, hsla, point, px};
        ...
        #visibility fn shadow_inset(mut self, shadows: smallvec::SmallVec<[kael::BoxShadow; 1]>) -> Self {
            let inset_shadows: smallvec::SmallVec<[kael::BoxShadow; 1]> = shadows.into_iter().map(|mut s| {
                s.inset = true;
                s
            }).collect();
        ...
        #visibility fn inset_shadow(mut self, color: kael::Hsla, blur: kael::Pixels, spread: kael::Pixels) -> Self {
            use kael::{BoxShadow, point, px};
...
fn generate_predefined_setter(
    ...
    let field_assignments = fields
        ...
        .map(|field_tokens| {
            quote! {
                style.#field_tokens = Some((#negation_token kael::#length_tokens).into());
            }
        })
        .collect::<Vec<_>>();
