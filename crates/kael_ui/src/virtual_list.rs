...
pub struct UniformVirtualList {
    ...
    overscan: usize,
    base: Stateful<Div>,
    scroll_handle: kael::ScrollHandle,
...
impl UniformVirtualList {
    ...
    pub fn track_scroll(mut self, handle: &kael::ScrollHandle) -> Self {
    ...
    pub fn scroll_to(&self, index: usize, strategy: kael::ScrollStrategy) {
    ...
    pub fn scroll_to_animated(&self, index: usize, window: &Window) {
        if let Some(ref physics) = self.physics_state {
            ...
            self.scroll_to(index, kael::ScrollStrategy::Top);
        }
    }
}
...
impl Element for UniformVirtualList {
    ...
    fn request_layout(
        ...
        inspector_id: Option<&kael::InspectorElementId>,
        window: &mut Window,
        cx: &mut App,
...
impl<P: ItemExtentProvider + 'static> VariableVirtualList<P> {
    ...
    pub fn scroll_to(&mut self, index: usize, strategy: kael::ScrollStrategy) {
