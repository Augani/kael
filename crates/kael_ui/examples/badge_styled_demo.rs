                        ...
                        VStack::new()
                            ...
                            .child(
                                Badge::new("Featured")
                                    ...
                                    .bg(kael::hsla(260.0 / 360.0, 0.6, 0.5, 1.0))  // Styled trait
                                    .text_color(kael::white())
                            ...
                            .child(
                                Badge::new("Exclusive Offer")
                                    ...
                                    .bg(kael::hsla(340.0 / 360.0, 0.82, 0.52, 1.0))  // Styled trait - pink/red
                                    .text_color(kael::white())
                                    .rounded(px(20.0))  // Styled trait
                                    .shadow_lg()  // Styled trait
                                    .border_2()
                                    .border_color(kael::hsla(340.0 / 360.0, 0.82, 0.62, 1.0))
                                    .text_size(px(14.0))
                                    .font_weight(FontWeight::SEMIBOLD)
                            )
                    )
