...
impl ShowcaseApp {
    fn new(cx: &mut Context<Self>) -> Self {
        let typewriter_state = cx.new(|_cx| {
            TypeWriterState::new(
                "Welcome to kael_ui — a beautiful component library for GPUI desktop apps.",
            )
        ...
        Self {
            ...
            typewriter_state,
            counter_state,
            copy_state: cx.new(|_cx| CopyButtonState::new("cargo add kael_ui".into())),
                                ...
                                ExpandableCard::new("expand-1", expandable_1)
                                    ...
                                    .expanded(
                                        col()
                                            ...
                                            .child(h3("What is kael_ui?"))
                                            .child(body(
                                                "kael_ui is a comprehensive component library for building \
                                ...
                                ExpandableCard::new("expand-2", expandable_2)
                                    ...
                                    .expanded(
                                        col()
                                            ...
                                            .child(h3("Getting Started"))
                                            .child(body(
                                                "Add kael_ui to your Cargo.toml, call init() in your app \
                        ...
                        row()
                            ...
                            .child(
                                col()
                                    .items_center()
                                    .child(
                                        QRCodeComponent::new("kael_ui: 85+ GPUI components")
                                            .size(px(150.0))
        ...
        cx.open_window(
            WindowOptions {
                ...
                titlebar: Some(TitlebarOptions {
                    title: Some("kael_ui Component Showcase".into()),
                    ..Default::default()
                }),
                ..Default::default()
            },
